...
export default function JWTParser() {
    ...
    const { buttonText: headerText, handleCopy: handleCopyHeader } = useCopyToClipboard();
    const { buttonText: payloadText, handleCopy: handleCopyPayload } = useCopyToClipboard();
    const { buttonText: signatureText, handleCopy: handleCopySignature } = useCopyToClipboard();
    ...
    return (<main>
      ...
      <section className="container max-w-2xl mb-12">
        <PageHeader title="JWT Parser" description="Fast, free, open source, ad-free tools."/>
      </section>
      ...
      <section className="container max-w-2xl mb-6">
        <Card className="flex flex-col p-6 hover:shadow-none shadow-none rounded-xl">
          <div>
            ...
            <Textarea rows={3} placeholder="Paste JWT here" onChange={handleChange} className="mb-6" value={input}/>
            ...
            <div>
              ...
              <Button variant="outline" onClick={() => handleCopyHeader(header)}>
                {headerText}
              </Button>
            </div>
            ...
            <div>
              ...
              <Button variant="outline" onClick={() => handleCopyPayload(payload)}>
                {payloadText}
              </Button>
            </div>
            ...
            <div>
              ...
              <Textarea value={signature} rows={1} readOnly className="mb-4 min-h-0"/>
              <Button variant="outline" onClick={() => handleCopySignature(signature)}>
                {signatureText}
              </Button>
            </div>
          </div>
