...
export default function WcagColorContrastChecker() {
    ...
    const handleColorChange = useCallback((setter) => (event) => {
    ...
    const contrastResult = useMemo(() => calculateContrast({
        foregroundHex: foreground,
        backgroundHex: background,
    }), [foreground, background]);
    return (<main>
      <Meta title="WCAG Color Contrast Checker | Accessibility Tool | Free & Open Source" description="Check color contrast ratios for WCAG AA and AAA compliance. Ensure your designs meet accessibility standards with our free color contrast checker tool."/>
      <Header />
      <CMDK />

      <section className="container max-w-2xl mb-12">
        <PageHeader title="WCAG Color Contrast Checker" description="Free, Open Source & Ad-free"/>
      </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <Input placeholder="#000000" onChange={handleColorChange(setForeground)} className="h-8 text-sm max-w-[110px]" value={foreground} maxLength={7}/>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mt-2">
                  <Input placeholder="#FFFFFF" onChange={handleColorChange(setBackground)} className="h-8 text-sm max-w-[110px]" value={background} maxLength={7}/>
            ...
            {fgValid && bgValid && contrastResult && (<>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        <ComplianceBadge passed={contrastResult.aa.normal} level={`WCAG AA (${WCAG.AA.NORMAL_THRESHOLD}:1)`}/>
                        <ComplianceBadge passed={contrastResult.aaa.normal} level={`WCAG AAA (${WCAG.AAA.NORMAL_THRESHOLD}:1)`}/>
                      </div>
                      <div className="p-4 rounded border" style={{ backgroundColor: normalizedBackground }}>
                        <p style={{
                ...
                fontWeight: "normal",
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        <ComplianceBadge passed={contrastResult.aa.large} level={`WCAG AA (${WCAG.AA.LARGE_THRESHOLD}:1)`}/>
                        <ComplianceBadge passed={contrastResult.aaa.large} level={`WCAG AAA (${WCAG.AAA.LARGE_THRESHOLD}:1)`}/>
                      </div>
                      <div className="p-4 rounded border" style={{ backgroundColor: normalizedBackground }}>
                        <p style={{
                color: normalizedForeground,
                ...
                fontWeight: "normal",
                    ...
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2 mb-3">
                        <ComplianceBadge passed={contrastResult.aa.graphicalObjects} level={`WCAG AA (${WCAG.AA.GRAPHICAL_OBJECTS_THRESHOLD}:1)`}/>
                      </div>
                      <div className="p-4 rounded border flex flex-col items-center gap-3" style={{ backgroundColor: normalizedBackground }}>
                        <Star size={24} fill={normalizedForeground} style={{ color: normalizedForeground }}/>
                        <Input placeholder="Text Input" className="w-full max-w-xs" style={{
