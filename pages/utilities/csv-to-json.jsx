...
Bob,35,UK`;
    ...
    return (<main>
      ...
      <section className="container max-w-2xl mb-12">
        <PageHeader title="CSV to JSON Converter" description="Fast, free, open source, ad-free tools."/>
      </section>
        ...
        <Card className="flex flex-col p-6 hover:shadow-none shadow-none rounded-xl">
          <div>
            ...
            <div className="relative" onDragOver={handleDragOver} onDragLeave={handleDragLeave} onDrop={handleDrop}>
              <Textarea rows={6} placeholder="Paste or drag and drop a CSV file" onInput={handleChange} onPaste={handlePaste} className={cn("mb-6", {
