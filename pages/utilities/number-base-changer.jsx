...
export default function NumberBaseChanger() {
    ...
    return (<main>
      <Meta title="Number Base Changer | Free, Open Source & Ad-free" description="Easily convert numbers between different bases (binary, decimal, hexadecimal) with our free online Number Base Changer. Perfect for developers and mathematicians looking for quick base conversions"/>
      <Header />
      <CMDK />

      <section className="container max-w-2xl mb-12">
        <PageHeader title="Number Base Changer" description="Fast, free, open source, ad-free tools."/>
      </section>
      ...
      <section className="container max-w-2xl mb-6">
        <Card className="flex flex-col p-6 hover:shadow-none shadow-none rounded-xl">
          <div>
            <Label>Number</Label>
            <Textarea className="mb-6" value={input} onChange={handleChange} rows={3}/>

            <div className="mb-6 flex w-full gap-4">
              <div className="flex flex-1 flex-col">
                <Label>From</Label>
                <Combobox data={data} value={base.from.toString()} onSelect={(value) => {
            setBase((prev) => ({
                ...prev,
                from: parseInt(value),
            }));
              ...
              <div className="flex flex-1 flex-col">
                <Label>To</Label>
                <Combobox data={data} value={base.to.toString()} onSelect={(value) => {
