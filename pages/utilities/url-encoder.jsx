...
export default function URLEncoder() {
    ...
    return (<main>
      ...
      <section className="container max-w-2xl mb-12">
        <PageHeader title="URL encoder/decoder" description="Free, Open Source & Ad-free"/>
      </section>
        ...
        <Card className="flex flex-col p-6 hover:shadow-none shadow-none rounded-xl">
          <Tabs defaultValue="encoder" className="mb-6">
            <TabsList className="flex">
              <TabsTrigger className="flex flex-1" value="encoder" onClick={() => setActiveTab("encoder")}>
                Encode
              </TabsTrigger>
              <TabsTrigger className="flex flex-1" onClick={() => setActiveTab("decoder")} value="decoder">
                Decode
              </TabsTrigger>
            </TabsList>
          </Tabs>
          ...
          <div>
            ...
            <Textarea rows={6} placeholder="Paste here" onChange={handleInput} className="mb-6" value={input}/>
