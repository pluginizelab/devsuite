import { isValidHex, isRGBValueValid, convertToRGB, convertToHex, toCss, toIOS, toAndroidColor, } from "./hex-to-rgb.utils";
describe("hex-to-rgb.utils", () => {
    ...
    test("toIOS should convert RGB values to iOS UIColor string", () => {
        const rgb = { r: "255", g: "255", b: "255" };
        expect(toIOS(rgb, "swift")).toBe("UIColor(red: 1.00, green: 1.00, blue: 1.00, alpha: 1.00)");
        expect(toIOS(rgb, "c")).toBe("[UIColor colorWithRed: 1.00 green: 1.00 blue: 1.00 alpha: 1.0]");
    });
