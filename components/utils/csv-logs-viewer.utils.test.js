...
import { parseCSV, buildFacets, filterRows, detectLogLevel, detectIfLogsFile, formatDate, isDateColumn, } from "./csv-logs-viewer.utils";
...
Jane,25`;
    ...
    describe("detectLogLevel", () => {
        ...
        it("should detect warning level", () => {
            expect(detectLogLevel({ message: "Warning: deprecated" })).toBe("warning");
    ...
    describe("performance benchmark", () => {
        it("should parse 1000-row CSV efficiently", () => {
            const csvPath = path.join(__dirname, "../../__tests__/fixtures/customers-1000.csv");
