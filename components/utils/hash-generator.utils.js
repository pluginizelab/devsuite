...
export const generateHash = (algorithm, data, encoding = "hex", secretKey) => {
    ...
    try {
        ...
        throw new Error(`Failed to generate hash: ${error instanceof Error ? error.message : "An unknown error occurred"}`);
    }
};
