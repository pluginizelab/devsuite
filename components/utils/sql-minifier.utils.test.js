...
/* another comment */`;
        ...
        test("should throw error for non-string input", () => {
            expect(() => minifySQL(null)).toThrow("Input must be a string");
            expect(() => minifySQL(undefined)).toThrow("Input must be a string");
            expect(() => minifySQL(123)).toThrow("Input must be a string");
        });
    ...
    describe("validateSQLInput", () => {
        ...
        test("should reject non-string input", () => {
            const result = validateSQLInput(123);
