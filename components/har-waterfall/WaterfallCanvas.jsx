...
export const WaterfallCanvas = ({ entries, timings, zoomLevel, width, height, scrollOffset, hoveredIndex, }) => {
    ...
    useEffect(() => {
        ...
        entries.forEach((entry, index) => {
            ...
            ctx.font = mediumFont;
            ctx.textAlign = "right";
            ctx.fillText(`${timing.totalTime.toFixed(0)}ms`, width - 20, y + rowHeight / 2);
            ctx.textAlign = "left";
            // Separator line
            ctx.strokeStyle = "rgba(255, 255, 255, 0.05)";
            ctx.lineWidth = 1;
